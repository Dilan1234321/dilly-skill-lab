/**
 * General/professional learning profile alias. Mirrors Dilly's main site
 * URL convention (hellodilly.com/p/{slug}) so the cross-link can carry the
 * same prefix on both sides.
 *
